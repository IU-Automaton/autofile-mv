...
describe('mv', function () {
    ...
    beforeEach(function (done) {
        clean(function (err) {
            ...
            // copy assets
            fs.writeFileSync(assetsDir + 'file1.json', fs.readFileSync(__dirname + '/assets/file1.json'));
            fs.writeFileSync(assetsDir + 'file2', fs.readFileSync(__dirname + '/assets/file2'));
            fs.writeFileSync(assetsDir + '.file', fs.readFileSync(__dirname + '/assets/.file'));
